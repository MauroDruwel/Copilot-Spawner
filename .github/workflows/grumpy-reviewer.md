...
engine:
  ...
  env:
    ...
    COPILOT_PROVIDER_API_KEY: $COPILOT_PROVIDER_API_KEY: ${{ secrets.OPENROUTER_API_KEY }}
...
timeout-minutes: 10
source: githubnext/agentics/workflows/grumpy-reviewer.md@3de4e604a36b5190a1c7dc4719c7341500ba8a95
---
